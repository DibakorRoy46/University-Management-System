...
namespace UMS.Data.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        public UnitOfWork(ApplicationDbContext db)
        {
            ...
            StudentSemeterFee = new StudentSemeterFeeRepository(db);
            EmployeeDetials = new EmployeeDetialsRepository(db);
        ...
        public IStudentSemeterFeeRepository StudentSemeterFee { get; private set; }

        public IEmployeeDetialsRepository EmployeeDetials { get; private set; }
